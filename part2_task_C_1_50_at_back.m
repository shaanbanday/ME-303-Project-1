...
a = 1.186; % Distance from centre of mass to the front axle (m)
b = 1.284;  % Distance from centre of mass to the rear axle (m)
Cf = 25000; % Front tire cornering stiffness (N/rad)
Cr = 21000; % Rear tire cornering stiffness (N/rad)
Iz = 2420; % Yaw inertia (kg·m^2)
dt = 0.5; % Δt (grid spacing)
t = 0:dt:100000; % Simulate for 100000 seconds
x0 = [0; 0]; % Initial conditions
delta = 0.1; % Step steering angle (rad)
speeds_kmh = [103.22, 103.23, 103.24]; % Speeds to test
